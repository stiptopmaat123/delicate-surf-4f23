...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/delicate-surf-4f23#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/delicate-surf-4f23
```

A live public deployment of this template is available at [https://delicate-surf-4f23.templates.workers.dev](https://delicate-surf-4f23.templates.workers.dev)
